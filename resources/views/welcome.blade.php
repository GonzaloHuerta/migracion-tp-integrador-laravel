    @extends('base')
      ...
      <section class="vip-products">
        ...
        <article class="product">
          <img src="images/banana.jpg" alt="apple">
          <div class="precio">
            <h4>Banana</h4>
            <p>$4.98</p>
          </div>
        ...
        <article class="product">
          <img src="images/papas.jpg" alt="apple">
          <div class="precio">
            <h4>Potato</h4>
            <p>$2.74</p>
          </div>
        ...
        <article class="product">
          <img src="images/sandias.jpg" alt="apple">
          <div class="precio">
            <h4>Sandia</h4>
            <p>$16.40</p>
          </div>
        ...
        <article class="product">
          <img src="images/zanahoria.jpg" alt="apple">
          <div class="precio">
            <h4>Zanahoria</h4>
            <p>$5.20</p>
          </div>
        ...
        <article class="product">
          <img src="images/morron.jpg" alt="apple">
          <div class="precio">
